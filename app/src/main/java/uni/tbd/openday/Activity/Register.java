...
public class Register extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        signUpNameEditTxt = (EditText) findViewById(R.id.reg_name);
        signUpEmailEditTxt = (EditText) findViewById(R.id.reg_email);
        signUppasswordEditTxt = (EditText) findViewById(R.id.reg_pass);
        signUpConfirmPasswordEditTxt = (EditText) findViewById(R.id.reg_repass);
        returnToLoginTextV = (TextView) findViewById(R.id.btn_exit);
