...
public class MessageAdapter extends RecyclerView.Adapter<MessageAdapter.MessageHolder> {
    ...
    public class RightMessageHolder extends MessageHolder {
        ...
        void bind(Message message) {
            ...
            if (message.getOwner_photo_url() != null) Picasso.get().load(message.getOwner_photo_url()).placeholder(R.drawable.user_photo_holder).resize(ImageUtils.SIZE_M, ImageUtils.SIZE_M).into(bind.photo);
        }
    }
