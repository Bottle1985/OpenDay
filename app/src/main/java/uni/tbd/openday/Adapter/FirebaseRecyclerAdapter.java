...
public abstract class FirebaseRecyclerAdapter<ViewHolder extends RecyclerView.ViewHolder, T>
    ...
    public FirebaseRecyclerAdapter(Query query, Class<T> itemClass,
        ...
        System.out.println("Good luck Boong 9 " + query);
    ...
    private ChildEventListener mListener = new ChildEventListener() {
        ...
        public void onChildAdded(DataSnapshot dataSnapshot, String previousChildName) {
            ...
            System.out.println("Good luck Boong 10 " + dataSnapshot.getKey());
            if (!mKeys.contains(key)) {

                System.out.println("Good luck Boong 11 " + FirebaseRecyclerAdapter.this.mItemClass);
                System.out.println("Good luck Boong 12 " + dataSnapshot.getValue());
                ...
                System.out.println("Good luck Boong 13 " + item + key + insertedPosition);
